...
#define ETH_IS_ADDR_BROADCAST(a) \
	((((const __u8 *) (a))[0] == 0xff) && \
	 (((const __u8 *) (a))[1] == 0xff) && \
	 (((const __u8 *) (a))[2] == 0xff) && \
	 (((const __u8 *) (a))[3] == 0xff) && \
...
enum sctp_param {
	...
	/* RE-CONFIG. Section 4 */
	SCTP_PARAM_RESET_OUT_REQUEST		= 0x000d,
	SCTP_PARAM_RESET_IN_REQUEST		= 0x000e,
	SCTP_PARAM_RESET_TSN_REQUEST		= 0x000f,
	SCTP_PARAM_RESET_RESPONSE		= 0x0010,
	SCTP_PARAM_RESET_ADD_OUT_STREAMS	= 0x0011,
