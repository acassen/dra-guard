...
#ifndef _DRA_SCTP_PROTO_H
#define _DRA_SCTP_PROTO_H


/* Prototypes */
extern int dra_sctp_worker_start(dra_sctp_proxy_t *);
extern int dra_sctp_proto_init(dra_sctp_proxy_t *);
extern int dra_sctp_proto_destroy(dra_sctp_proxy_t *);
