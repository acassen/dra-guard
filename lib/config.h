...
#define PROG                    "dra-guard"
#define PROG_PID_FILE		"/var/run/dra-guard.pid"
#define VERSION_STRING PROG	" v1.0.9 (2024/10/14)"
#define COPYRIGHT_STRING	"Copyright (C) 2024 Alexandre Cassen, <acassen@gmail.com>"
